...
@section('cabecalho')
    @include('layouts.cabecalho', ['titulo' => 'Novo Distrito', 'rota' => 'cadaux-distritos'])
@endsection
...
<div class="container containerTabela justify-content-center">
    ...
    <div class="container">
        {!! Form::open(array('route' => 'cadaux-distritos-store','method'=>'POST')) !!}
            <div class="form-group required mb-3">
                <label class="control-label"><strong>Subprefeitura: </strong></label>
                {!! Form::select('subprefeitura_id', $subprefeituras, null, array('class' => 'form-select','required','placeholder' => '-- Selecione --')) !!}
            </div>
            <div class="form-group required mb-3">
