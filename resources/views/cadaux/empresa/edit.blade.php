...
@section('cabecalho')
    @include('layouts.cabecalho', ['titulo' => 'Editar Empresa', 'rota' => 'cadaux-empresas'])
@endsection
...
<div class="container containerTabela justify-content-center">
    ...
    <div class="container">
        {!! Form::model($empresa, ['route' => ['cadaux-empresas-update', $empresa->id], 'method'=>'POST']) !!}
            <div class="form-group required mb-3">
                <label class="control-label"><strong>Nome: </strong></label>
                {!! Form::text('nome', null, array('placeholder' => 'Nome completo do Empresa','class' => 'form-control','required','maxlength'=>255)) !!}
            </div>
            ...
            <div class="form-group mb-3">
                ...
                {!! Form::text('email', null, array('placeholder' => 'Endereço de E-mail','id'=>'email','class' => 'form-control')) !!}
            </div>
            <div class="col form-group mb-3">
                <label for="telefone" class="control-label"><strong>Telefone Fixo: </strong></label>
                {!! Form::text('telefone', null, array('placeholder' => '(11) 1234-5678','id'=>'telefone','class' => 'form-control phone')) !!}
            </div>
