...
@section('cabecalho')
    @include('layouts.cabecalho', ['titulo' => 'Nova Subprefeitura', 'rota' => 'cadaux-subprefeituras'])
@endsection
...
<div class="container containerTabela justify-content-center">
    ...
    <div class="container">
        {!! Form::open(array('route' => 'cadaux-subprefeituras-store','method'=>'POST')) !!}
            <div class="form-group required mb-3">
                <label class="control-label"><strong>Região: </strong></label>
                {!! Form::select('regiao', $regioes, null, array('class' => 'form-select','required','placeholder' => '-- Selecione --')) !!}
            </div>
            <div class="form-group required mb-3">
